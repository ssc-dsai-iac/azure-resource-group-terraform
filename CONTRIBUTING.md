...
## Report bugs using Github's [issues](https://github.com/ssc-dsai-iac/azure-resource-group-terraform/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/ssc-dsai-iac/azure-resource-group-terraform/issues);

## Security Issue
Do not post any security issues on the public repository! See [SECURITY.md](https://github.com/ssc-dsai-iac/azure-resource-group-terraform/security/policy)
...
## Signaler les bogues à l'aide des [problèmes](https://github.com/ssc-dsai-iac/azure-resource-group-terraform/issues) de Github
Nous utilisons les problèmes GitHub pour suivre les bogues publics. Signalez un bogue en [ouvrant un nouveau problème](https://github.com/ssc-dsai-iac/azure-resource-group-terraform/issues)

## Problème de sécurité
Ne publiez aucun problème de sécurité sur le référentiel public ! Voir [SECURITY.md](https://github.com/ssc-dsai-iac/azure-resource-group-terraform/security/policy)
